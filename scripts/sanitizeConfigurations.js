...
const sanitizeDocument = (document) => {
  try {
    ...
    sanitizedDocument.name =
      document === null || document === void 0 ? void 0 : document.naam;
    sanitizedDocument.resourceReference =
      document === null || document === void 0 ? void 0 : document.waarde;
...
const isUrl = (str) => {
  try {
    if (!str) return false;
    const regex =
      /^https?:\/\/([a-z\d-]+(\.[a-z\d-]+)*\.[a-z]{2,}|(\d{1,3}\.){3}\d{1,3})(:\d+)?(\/\S*)?$/i;
  ...
  const navigationLink = {
    ...
    resourceReference: isUrl(
      ...
      ? document === null || document === void 0
        ...
        : document.resourceReference
      : convertFileToUri(
          (_a = document.resourceReference) !== null && _a !== void 0 ? _a : "",
          folder,
          path
        ),
  };
...
const convertToStandard = (configuration) => {
  ...
  const standard = {
    ...
    responsibleOrganisation:
      configuration === null || configuration === void 0
        ? void 0
        : configuration.responsibleOrganisation,
    publicationDate:
      configuration === null || configuration === void 0
        ? void 0
        : configuration.publicationDate,
    specificationDocuments:
      ((_b =
        configuration === null || configuration === void 0
          ? void 0
          : configuration.specificationDocuments) === null || _b === void 0
        ? void 0
        : _b.map((document) =>
            convertResourceReferenceToUri(
              document,
              DOCUMENTS,
    ...
    documentation:
      ((_c =
        configuration === null || configuration === void 0
          ? void 0
          : configuration.documentation) === null || _c === void 0
        ? void 0
        : _c.map((document) =>
            convertResourceReferenceToUri(
              document,
    ...
    reports:
      ((_d =
        configuration === null || configuration === void 0
          ? void 0
          : configuration.reports) === null || _d === void 0
        ? void 0
        : _d.map((document) =>
            convertResourceReferenceToUri(
              document,
    ...
    charter: convertResourceReferenceToUri(
      configuration === null || configuration === void 0
        ? void 0
    ...
    presentations:
      ((_e =
        configuration === null || configuration === void 0
          ? void 0
          : configuration.presentations) === null || _e === void 0
        ? void 0
        : _e.map((document) =>
            convertResourceReferenceToUri(
              document,
    ...
    dateOfRegistration:
      configuration === null || configuration === void 0
        ? void 0
        : configuration.dateOfRegistration,
    ...
    datePublicReviewEnd:
      configuration === null || configuration === void 0
        ? void 0
        : configuration.datePublicReviewEnd,
    datePublicReviewStart:
      configuration === null || configuration === void 0
        ? void 0
        : configuration.datePublicReviewStart,
    endOfPublicationDate:
      configuration === null || configuration === void 0
        ? void 0
        : configuration.endOfPublicationDate,
  };
  return standard;
};
  ...
  const sanitizedConfiguration = {
    ...
    specificationDocuments:
      ((_a =
        configuration === null || configuration === void 0
          ? void 0
          : configuration.specificatiedocument) === null || _a === void 0
        ? void 0
        : _a.map((document) => sanitizeDocument(document))) || [],
    documentation:
      ((_b =
        configuration === null || configuration === void 0
          ? void 0
          : configuration.documentatie) === null || _b === void 0
        ? void 0
        : _b.map((document) => sanitizeDocument(document))) || [],
    charter: !!((_c =
      configuration === null || configuration === void 0
        ? void 0
        : configuration.charter) === null || _c === void 0
      ? void 0
      : _c.length)
      ? sanitizeDocument(
          configuration === null || configuration === void 0
            ? void 0
            : configuration.charter[0]
        )
      : {},
    reports:
      ((_d =
        configuration === null || configuration === void 0
          ? void 0
          : configuration.verslagen) === null || _d === void 0
        ? void 0
        : _d.map((document) => sanitizeDocument(document))) || [],
    presentations:
      ((_e =
        configuration === null || configuration === void 0
          ? void 0
          : configuration.presentaties) === null || _e === void 0
        ? void 0
        : _e.map((document) => sanitizeDocument(document))) || [],
    dateOfRegistration:
      configuration === null || configuration === void 0
        ? void 0
        : configuration.datum_van_aanmelding,
    dateOfAcknowledgementByWorkingGroup:
      configuration === null || configuration === void 0
        ? void 0
        : configuration.erkenning_werkgroep_datastandaarden,
    dateOfAcknowledgementBySteeringCommittee:
      configuration === null || configuration === void 0
        ? void 0
        : configuration.erkenning_stuurgroep,
    fileName:
      configuration === null || configuration === void 0
        ? void 0
    ...
    datePublicReviewEnd:
      configuration === null || configuration === void 0
        ? void 0
        : configuration.datum_einde_review,
    datePublicReviewStart: "",
    endOfPublicationDate: "",
  };
...
const writeStandard = (standard, dir, innerFile) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      ...
      yield fs_1.default.promises.writeFile(
        path_1.default.join(directoryPath, innerFile),
        data,
        "utf8"
      );
    } catch (err) {
...
const sanitizeAndReadConfigurations = () =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
          ...
          if (stats.isDirectory()) {
            ...
            for (const innerFile of innerFiles) {
              ...
              if (path_1.default.extname(innerFile) === ".json") {
                const data = yield fs_1.default.promises.readFile(
                  fullPathToFile,
                  "utf8"
                );
                try {
                  const configuration = JSON.parse(data);
                  const standard = convertToStandard(
                    cleanupConfig(sanitizeConfiguration(configuration))
                  );
                ...
                try {
                  yield fs_1.default.promises.copyFile(
                    fullPathToFile,
                    destinationPath
                  );
                } catch (err) {
